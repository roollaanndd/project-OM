  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <article className="mx-auto max-w-3xl px-5 py-28 lg:px-8">
        <h1 className="font-display text-4xl font-extrabold text-gray-900">Syarat & Ketentuan</h1>
        <p className="mt-2 text-sm text-gray-900/55">Terakhir diperbarui: 29 Juni 2025</p>

        <div className="mt-8 space-y-6 text-base leading-relaxed text-foreground/75">
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">1. Penerimaan Syarat</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">2. Layanan</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">3. Janji Temu</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">4. Pembayaran</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">5. Garansi</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">6. Tanggung Jawab</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">7. Perubahan Syarat</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">8. Kontak</h2>
            <p className="mt-2">Email: <Link href="mailto:halo@omdc-dental.id" className="text-gray-700 hover:underline">halo@omdc-dental.id</Link> · Telepon: +62 812-3456-7890</p>
          </section>
        </div>
      </article>
    </main>
