  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <article className="mx-auto max-w-3xl px-5 py-28 lg:px-8">
        <h1 className="font-display text-4xl font-extrabold text-gray-900">Kebijakan Privasi</h1>
        ...
        <div className="mt-8 space-y-6 text-base leading-relaxed text-foreground/75">
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">1. Pendahuluan</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">2. Data yang Kami Kumpulkan</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">3. Penggunaan Data</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">4. Pembagian Data</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">5. Keamanan Data</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">6. Hak Anda</h2>
            <ul className="mt-2 space-y-1.5 list-disc pl-5">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900">7. Cookie</h2>
            <p className="mt-2">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              Email: <Link href="mailto:privacy@omdc-dental.id" className="text-gray-700 hover:underline">privacy@omdc-dental.id</Link><br />
