    ...
    <main className="min-h-screen bg-gradient-to-b from-pink-50 via-white to-pink-50">
      <section className="mx-auto max-w-4xl px-5 py-14 lg:px-8 lg:py-20">
        <nav aria-label="Breadcrumb" className="mb-6 text-xs text-pink-950/55">
          ...
          <span className="font-bold text-pink-700">Kontak</span>
        </nav>
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2">
          <div className="rounded-3xl border border-pink-100 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-pink-950">Alamat Klinik</h2>
          ...
          <div className="rounded-3xl border border-pink-100 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-pink-950">Telepon & WhatsApp</h2>
                <a href="tel:+6281234567890" className="text-sm font-medium text-pink-700 hover:underline">
                  +62 812-3456-7890
                </a>
              </div>
            </div>
          ...
          <div className="rounded-3xl border border-pink-100 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-pink-950">Email</h2>
                <a href="mailto:halo@omdc-dental.id" className="text-sm font-medium text-pink-700 hover:underline">
                  halo@omdc-dental.id
                </a>
              </div>
            </div>
          ...
          <div className="rounded-3xl border border-pink-100 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-pink-950">Jam Operasional</h2>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          ...
          <Link
            href="/#booking"
            className="flex flex-1 items-center justify-center gap-2 rounded-full bg-gradient-to-r from-pink-600 to-rose-500 px-6 py-3.5 text-sm font-bold text-white shadow-soft-pink"
          >
            Buat Janji Online
          </Link>
        </div>
        ...
        {/* Embed map */}
        <div className="mt-8 overflow-hidden rounded-3xl border border-pink-100 shadow-sm">
          <iframe
            title="Lokasi OMDC"
