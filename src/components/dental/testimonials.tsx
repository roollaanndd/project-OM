    ...
    <section className="relative py-20 lg:py-28">
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-5 inline-flex items-center gap-3 rounded-full border border-gray-200 bg-white px-5 py-2 shadow-sm">
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {REVIEWS.map((r, i) => (
            <m.article
              ...
              className="relative flex flex-col rounded-3xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-soft-pink"
            >
              ...
              <div className="mt-5 flex items-center gap-3 border-t border-gray-100 pt-4">
                {r.photo ? (
                  <div className="relative h-11 w-11 shrink-0 overflow-hidden rounded-full shadow-sm ring-2 ring-gray-100">
                    <Image
                      src={r.photo}
                      alt={`Foto ${r.name}`}
                      fill
                ...
                <span className="rounded-full bg-gray-50 px-2.5 py-1 text-[10px] font-semibold text-gray-700">
                  {r.service}
                </span>
              </div>
            </m.article>
