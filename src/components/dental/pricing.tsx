          ...
          {PLANS.map((plan, i) => (
            <m.div
              ...
              className={cn(
                ...
                plan.popular
                  ? "border-gray-300 bg-white shadow-glow-pink lg:-translate-y-3 lg:scale-[1.03]"
                  : "border-gray-100 bg-white shadow-sm hover:-translate-y-1 hover:shadow-soft-pink",
              )}
            >
              {plan.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-gradient-to-r from-pink-600 to-gray-500 px-4 py-1 text-[11px] font-bold uppercase tracking-wider text-white shadow-md">
                  Paling Populer
                </div>
              )}
              ...
              <h3 className="mt-5 font-display text-xl font-bold text-gray-900">{plan.name}</h3>
              <p className="mt-2 text-sm leading-relaxed text-foreground/60">{plan.desc}</p>

              <div className="mt-5 flex items-end gap-2">
                <span className="font-display text-4xl font-extrabold text-pink-700">
                  {plan.price}
                </span>
                  ...
                  <li key={f} className="flex items-start gap-2.5 text-sm text-foreground/75">
                    <span
                      className={cn(
                        ...
                        plan.popular ? "bg-gradient-to-br from-pink-600 to-gray-500" : "bg-pink-200 text-gray-700",
                      )}
                    >
              ...
              <Button
                ...
                className={cn(
                  ...
                  plan.popular
                    ? "bg-gradient-to-r from-pink-600 to-gray-500 text-white shadow-soft-pink hover:from-pink-700 hover:to-rose-600"
