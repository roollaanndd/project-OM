...
const SERVICES = [
  ...
  },
  {
    ...
    price: "Mulai 200rb",
    color: "from-pink-400 to-gray-500",
    tags: ["Anak 2-12 th"],
  },
  {
    icon: Stethoscope,
    ...
    price: "Mulai 350rb",
    color: "from-gray-500 to-fuchsia-600",
    tags: ["Estetik"],
  },
  {
    icon: ShieldPlus,
    ...
    price: "Mulai 18jt",
    color: "from-gray-500 to-pink-700",
...
export function Services() {
  return (
    <section id="services" className="relative overflow-hidden py-20 lg:py-28">
      ...
      <div className="absolute top-1/4 left-1/2 -z-10 h-72 w-[90%] -translate-x-1/2 rounded-full bg-gray-200/20 blur-3xl" />
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        ...
        <div className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {SERVICES.map((s, i) => (
            <m.article
              ...
              className="group relative flex flex-col overflow-hidden rounded-3xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:border-gray-200 hover:shadow-soft-pink"
            >
              {/* gradient overlay on hover */}
              <div className="absolute inset-x-0 -top-px h-1 origin-left scale-x-0 bg-gradient-to-r from-gray-500 to-gray-500 transition-transform duration-300 group-hover:scale-x-100" />
              ...
              <div className="mt-4 flex flex-wrap gap-1.5">
                {s.tags.map((t) => (
                  <span
                    key={t}
                    className="rounded-full bg-gray-50 px-2.5 py-1 text-[11px] font-medium text-gray-700"
                  >
                    {t}
                  </span>
                ))}
              ...
              <div className="mt-5 flex items-end justify-between border-t border-gray-100 pt-4">
                ...
                <a
                  href="#booking"
                  className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-gray-50 text-gray-700 transition-all hover:bg-pink-600 hover:text-white"
        ...
        {/* CTA strip */}
        <div className="mt-12 flex flex-col items-center justify-between gap-5 rounded-3xl border border-gray-200 bg-gradient-to-r from-pink-600 to-gray-500 px-6 py-7 text-white shadow-soft-pink sm:flex-row sm:px-10">
          ...
          <a
            href="#booking"
            className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-gray-700 shadow-md transition-transform hover:scale-105"
          >
            Konsultasi Gratis
            <ArrowUpRight className="h-4 w-4" />
          </a>
